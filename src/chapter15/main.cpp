...
int main()
{
    ...
    window = glfwCreateWindow(800, 600, "Chapter15", nullptr, nullptr);
    if (!window)
    {
    ...
    torus = std::make_unique<glsl_shader::Torus>(0.7f, 0.3f, 50, 50);
    program.SetUniform("u_material.Kd", 0.8f, 0.8f, 0.8f);
...
{
    // 创建顶点着色器
    program.CompileShader("../../assets/shaders/chapter15/directional_light.vs.glsl");
    program.CompileShader("../../assets/shaders/chapter15/directional_light.fs.glsl");
    program.Link();
    program.Use();
    ...
    program.SetUniform("u_light.position_in_view", view * glm::vec4(1.0f, 0.0f, 0.0f, 0.0f));
    program.SetUniform("u_light.L", glm::vec3(0.8f, 0.8f, 0.8f));
