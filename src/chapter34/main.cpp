...
int main()
{
    ...
    window = glfwCreateWindow(800, 600, "Chapter34", nullptr, nullptr);
    if (!window)
    {
...
{
    // 创建顶点着色器
    program.CompileShader("../../assets/shaders/chapter34/edge_detection.vs.glsl");
    program.CompileShader("../../assets/shaders/chapter34/edge_detection.fs.glsl");
    program.Link();
    program.Use();
    ...
    program.SetUniform("u_edge_threshold", 0.05f);
