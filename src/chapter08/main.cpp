...
int main()
{
    ...
    window = glfwCreateWindow(800, 600, "Chapter08", nullptr, nullptr);
    if (!window)
    {
...
{
    // 创建顶点着色器
    program.CompileShader("../../assets/shaders/chapter08/phong.vs.glsl");
    program.CompileShader("../../assets/shaders/chapter08/phong.fs.glsl");
    program.Link();
    program.Use();
