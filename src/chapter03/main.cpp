...
int main()
{
    ...
    window = glfwCreateWindow(800, 600, "Chapter03", nullptr, nullptr);
    if (!window)
    {
...
void LoadShaderFromSourceCode()
{
    ...
    std::string vertex_shader_source = LoadShaderSource("../../assets/shaders/chapter03/use_uniform_block.vs.glsl");
    ...
    std::string fragment_shader_source = LoadShaderSource("../../assets/shaders/chapter03/use_uniform_block.fs.glsl");
