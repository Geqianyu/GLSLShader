...
int main()
{
    ...
    window = glfwCreateWindow(800, 600, "Chapter10", nullptr, nullptr);
    if (!window)
    {
    ...
    // 创建 Teapot
    teapot = new glsl_shader::Teapot(13, glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 1.5f, 0.25f)));
...
{
    // 创建顶点着色器
    program.CompileShader("../../assets/shaders/chapter10/two_sides.vs.glsl");
    program.CompileShader("../../assets/shaders/chapter10/two_sides.fs.glsl");
    program.Link();
    program.Use();
