...
int main()
{
    ...
    window = glfwCreateWindow(800, 600, "Chapter26", nullptr, nullptr);
    if (!window)
    {
...
{
    // 创建顶点着色器
    program.CompileShader("../../assets/shaders/chapter26/use_parallax_texture.vs.glsl");
    program.CompileShader("../../assets/shaders/chapter26/use_parallax_texture.fs.glsl");
    program.Link();
    program.Use();
