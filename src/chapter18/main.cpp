...
int main()
{
    ...
    window = glfwCreateWindow(800, 600, "Chapter18", nullptr, nullptr);
    if (!window)
    {
...
{
    // 创建顶点着色器
    program.CompileShader("../../assets/shaders/chapter18/spot_light.vs.glsl");
    program.CompileShader("../../assets/shaders/chapter18/spot_light.fs.glsl");
    program.Link();
    program.Use();
