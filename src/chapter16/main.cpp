...
int main()
{
    ...
    window = glfwCreateWindow(800, 600, "Chapter16", nullptr, nullptr);
    if (!window)
    {
...
{
    // 创建顶点着色器
    program.CompileShader("../../assets/shaders/chapter16/per_fragment.vs.glsl");
    program.CompileShader("../../assets/shaders/chapter16/per_fragment.fs.glsl");
    program.Link();
    program.Use();
