...
int main()
{
    ...
    window = glfwCreateWindow(800, 600, "Chapter13", nullptr, nullptr);
    if (!window)
    {
...
{
    // 创建顶点着色器
    program.CompileShader("../../assets/shaders/chapter13/discard.vs.glsl");
    program.CompileShader("../../assets/shaders/chapter13/discard.fs.glsl");
    program.Link();
    program.Use();
