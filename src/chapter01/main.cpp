...
int main()
{
    ...
    window = glfwCreateWindow(800, 600, "Chapter01", nullptr, nullptr);
    if (!window)
    {
...
void LoadShaderFromSourceCode()
{
    ...
    std::string vertex_shader_source = LoadShaderSource("../../assets/shaders/chapter01/basic.vs.glsl");
    ...
    std::string fragment_shader_source = LoadShaderSource("../../assets/shaders/chapter01/basic.fs.glsl");
    ...
    for (int i = 0; i < attribs_num; ++i)
    {
        ...
        glGetProgramResourceiv(shader_program, GL_PROGRAM_INPUT, i, 3, properties, 3, nullptr, results);
