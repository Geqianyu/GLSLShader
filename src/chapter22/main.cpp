...
int main()
{
    ...
    window = glfwCreateWindow(800, 600, "Chapter22", nullptr, nullptr);
    if (!window)
    {
...
{
    // 创建顶点着色器
    program.CompileShader("../../assets/shaders/chapter22/use_2d_texture.vs.glsl");
    program.CompileShader("../../assets/shaders/chapter22/use_2d_texture.fs.glsl");
    program.Link();
    program.Use();
